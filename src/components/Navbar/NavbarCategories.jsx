        ...
        <div className="flex items-center gap-2">
          ...
          <div className="dropdown dropdown-end">
            ...
            <ul tabIndex={0} className="dropdown-content z-[1] p-2 shadow bg-base-100 rounded-box w-[349px]">
              <li>
                <div className="flex gap-[17px] hover:bg-gray-200 hover:rounded-lg p-2">
                  ...
                  <div className="flex flex-col gap-[12px]">
                    ...
                    <div className="w-[93px] h-[32px] bg-[#F3F3F7] justify-around rounded-[8px] flex items-center">
                      <button className="text-[18px] font-bold w-[30px] rounded-l-[8px]" onClick={subtractCount}>
                        -
                      </button>
                      <p className="text-[18px] font-bold">{itemCount}</p>
                      <button className="text-[18px] font-bold w-[30px] rounded-r-[8px]" onClick={addCount}>
                        +
                      </button>
                    </div>
                  </div>
